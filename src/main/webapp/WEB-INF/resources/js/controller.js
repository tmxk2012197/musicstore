...
cartApp.controller("cartCtrl", function ($scope, $http) {
    $scope.refreshCart = function (cartId) {
        $http.get('/musicStore/rest/cart/' + $scope.cartId).then(function (data) {
            $scope.cart = data;
        });
    };

    $scope.clearCart = function () {
        $http.delete('/musicStore/rest/cart/' + $scope.cartId).then($scope.refreshCart($scope.cartId));
    };
    ...
    $scope.addToCart = function (productId) {
        $http.put('/musicStore/rest/cart/add/' + productId).then(function (data) {
